...
BEGIN_MESSAGE_MAP(CCalendarApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CCalendarApp::OnAppAbout)
...
CCalendarApp::CCalendarApp()
{
	...
	SetAppID(_T("Calendar.AppID.NoVersion"));
...
// CCalendarApp customization load/save methods

void CCalendarApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CCalendarApp::LoadCustomState()
{
}

void CCalendarApp::SaveCustomState()
{
}
